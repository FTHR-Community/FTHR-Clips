...
Linux support, build instructions and requirements are maintained on the
[linux branch](https://github.com/FTHR-Community/FTHR-Clips/tree/linux).
Please open Linux-related pull requests against that branch, not `master`.
